...
export default function ArchivedAdminSvg({ className }: ArchivedAdminSvgProps): JSX.Element {
  ...
  return (
    <svg className={className} width="27" height="27" viewBox="0 0 27 27" fill="inherit" xmlns="http://www.w3.org/2000/svg">
      <mask id="mask0_508_130" style={maskStyle} maskUnits="userSpaceOnUse" x="0" y="0" width="27" height="27">
